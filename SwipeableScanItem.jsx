...
function SwipeableScanItem({ scan, onDelete, onViewDetail, onEdit }) {
    ...
    return (
        <>
            <div
                ref={itemRef}
                className="relative overflow-hidden bg-surface dark:bg-dark-card border border-line dark:border-dark-border rounded-2xl"
            >
                ...
                <div
                    className="relative bg-surface dark:bg-dark-card p-5 transition-transform duration-200 ease-out cursor-pointer"
                    style={{
                ...
                >
                        ...
                        <div className="flex items-center gap-1.5">
                            ...
                            {onEdit && (
                                <button
                                    ...
                                    className="p-1.5 text-gray-400 hover:text-ink-600 dark:hover:text-ink-400 hover:bg-ink-50 dark:hover:bg-ink-900/40 rounded-lg transition-colors"
                    ...
                    <div className="flex gap-2 flex-wrap">
                        {books.slice(0, 3).map((book, idx) => (
                            <span key={idx} className="text-xs bg-paper dark:bg-dark-bg border border-line dark:border-dark-border text-stone-700 dark:text-dark-text px-2 py-1 rounded">
                                {book.title}
                            </span>
                        ))}
                        {books.length > 3 && (
                    ...
                    {onListCount > 0 && (
                        <div className="mt-2 flex items-center gap-1">
                            <BookOpen className="w-3 h-3 text-ribbon-700 dark:ribbon-300" />
                            <span className="text-xs text-ribbon-700 dark:text-ribbon-300 font-medium">
