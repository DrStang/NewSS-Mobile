...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-ink-100 p-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-3 mb-2">
            <Book className="w-10 h-10 text-ink-600" />
            ...
            {!image && (
              <div className="flex gap-3 w-full max-w-md">
                <label className="flex-1 cursor-pointer">
                  <div className="px-6 py-3 bg-ink-600 text-white rounded-lg font-semibold hover:bg-ink-700 transition-colors flex items-center justify-center gap-2">
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          <span className="text-3xl font-bold text-ink-600">#{index + 1}</span>
                    ...
                    <div className="flex gap-3">
                      {book.infoLink && (
                        <a
                          ...
                          className="inline-block px-4 py-2 bg-ink-100 text-ink-700 rounded-lg hover:bg-ink-200 transition-colors font-medium"
                        >
                          Google Books →
                        </a>
                      )}
          ...
          <div className="mt-8 bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {books.slice(3).map((book, index) => (
                ...
                <div key={index} className="flex gap-3 p-4 border border-gray-200 rounded-lg hover:border-ink-300 transition-colors">
                  <div className="flex-1">
