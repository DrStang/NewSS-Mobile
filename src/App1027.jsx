...
// Add this function in your App component
  ...
  return (
      <>
        <DeepLinkHandler/>
        <div className="fixed inset-0 bg-gradient-to-br from-blue-50 to-ink-100 flex flex-col pt-safe">
                ...
                <div className="h-full overflow-y-auto"
                  ...
                  <div className="text-center mb-6">
                    <p className="text-sm text-gray-600 mb-2">
                      Thanks for using Shelf Scan! Let me know if you have any <a href="mailto:admin@shelfscan.xyz" className="text-ink-600">comments or suggestions</a>!
                    </p>
                  </div>
                </div>
            )}
