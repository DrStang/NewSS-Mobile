...
const HelpButton = () => {
    ...
    return (
        <>
            ...
            <button
                onClick={handleOpen}
                className="fixed bottom-24 right-6 w-14 h-14 bg-ink-600 dark:bg-ink-500 text-white rounded-full shadow-lg hover:bg-ink-700 dark:hover:bg-ink-600 transition-all hover:scale-110 active:scale-95 z-40 flex items-center justify-center"
            ...
            {showHelp && (
                <>
                    ...
                    <div className="fixed right-0 top-0 bottom-0 w-full max-w-md bg-white dark:bg-gray-900 shadow-2xl z-50 overflow-y-auto animate-slide-in-right">
                        ...
                        <div
                            className="sticky top-0 bg-gradient-to-br from-ink-600 to-ink-700 dark:from-ink-700 dark:to-ink-800 text-white shadow-md z-10"
                        ...
                        >
                            <div className="flex justify-between items-start">
                                <div>
                                    ...
                                    <p className="text-ink-100 text-sm">{i18n.t('help.subtitle')}</p>
                                </div>
                                <button
                                    onClick={handleClose}
                        ...
                        <div className="p-6 space-y-6" style={{ paddingBottom: 'max(env(safe-area-inset-bottom), 1.5rem)' }}>
                            ...
                            <section>
                                <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-3 flex items-center gap-2">
                                    <Camera className="w-5 h-5 text-ink-600 dark:text-ink-400" />
