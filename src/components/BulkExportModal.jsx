...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header h1 { color: #1e3d34; font-size: 32px; margin-bottom: 10px; }
        ...
        .summary-stat .value { font-size: 28px; font-weight: bold; color: #1e3d34; }
        ...
        .book-links a { color: #1e3d34; margin-right: 12px; text-decoration: none; }
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Selection Summary */}
                <div className="bg-ink-50 dark:bg-ink-900/30 px-5 py-3 flex items-center justify-between flex-shrink-0">
                    <div className="flex items-center gap-4">
                        <div className="text-center">
                            <div className="text-xl font-bold text-ink-600 dark:text-ink-400">{totals.scans}</div>
                    ...
                    <div className="flex gap-2">
                        <button
                            onClick={selectAll}
                            className="px-3 py-1.5 text-xs font-medium text-ink-600 dark:text-ink-400 hover:bg-ink-100 dark:hover:bg-ink-900/50 rounded-lg transition-colors"
                        >
                            ...
                            return (
                                <button
                                    ...
                                    className={`w-full text-left flex items-center gap-3 p-3 rounded-xl transition-all ${
                                        isSelected
                                            ? 'bg-ink-50 dark:bg-ink-900/30 border-2 border-ink-300 dark:border-ink-600'
                                            : 'bg-gray-50 dark:bg-gray-700 border-2 border-transparent hover:bg-gray-100 dark:hover:bg-gray-600'
                                    }`}
                                >
                                    {/* Checkbox */}
                                    <div className={`flex-shrink-0 ${isSelected ? 'text-ink-600 dark:text-ink-400' : 'text-gray-400'}`}>
                                        {isSelected ? (
