            ...
            {showHelp && (
                <>
                    ...
                    <div className="fixed right-0 top-0 bottom-0 w-full max-w-md bg-white shadow-2xl z-50 overflow-y-auto mt-6">
                        ...
                        <div className="sticky top-0 bg-gradient-to-br from-ink-600 to-ink-700 text-white shadow-md z-10" style={{ paddingTop: 'max(env(safe-area-inset-top)', paddingBottom: '1.5rem', paddingLeft: '1.5rem', paddingRight: '1.5rem' }}>
