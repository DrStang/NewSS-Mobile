                    ...
                    {stats.topAuthors && stats.topAuthors.length > 0 && (
                        <div>
                            ...
                            <div className="flex flex-wrap gap-1.5">
                               ...
                               text-gray-700 dark:text-gray-300 hover:border-ink-300 transition-colors"
                                    >
                                        {a.name} ({a.count})
                                    </button>
                                ))}
            ...
            <div className="flex gap-2">
                <div className="relative flex-1">
                    ...
                    <input
                       ...
                       placeholder-gray-400 focus:ring-2 focus:ring-ink-500 focus:border-transparent
                        ...
                        <>
                            ...
                            {scanHistory && scanHistory.length > 0 && (
                                <button
                                    ...
                                    className="px-5 py-2.5 bg-ink-600 text-white rounded-xl font-medium
                             hover:bg-ink-700 disabled:opacity-50 transition-colors
                    ...
                    {parseFloat(book.rating).toFixed(1)}
                            ...
                            {onEditBook && (
                                <button
                                    ...
                                    className="p-1.5 text-gray-400 hover:text-ink-600 dark:hover:text-ink-400
