                            ...
                            <div className="space-y-3">
                                {editableBooks.map((book, index) => (
                                    <div key={book._editId} className="group">
                                        {editingIndex === index ? (
                                            <div className="border-2 border-ink-300 dark:border-ink-500 rounded-lg p-4 bg-ink-50 dark:bg-gray-700">
                                                <div className="space-y-3">
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:ring-2 focus:ring-ink-500 focus:border-ink-500 dark:bg-gray-800 dark:text-gray-100"
